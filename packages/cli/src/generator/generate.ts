...
//       plan = buildCompositionPlan(result.ordered, registry.orm);
//     }
...
// ): Promise<void> {
//   const { applyConfigPatch } = await import("@systemlabs/foundation-core");
...
/**
 * cli/src/generator/generate.ts — RETIRED (Phase 1, item 4)
 *
 * Previously duplicated pipeline logic now handled by:
 *   src/commands/create.ts   (project scaffold via runExecutionPipeline)
 *   src/commands/generate.ts (model/CRUD code generation)
 */
export {};