...
<a href="https://www.star-history.com/?repos=ronak-create%2FFoundation-Cli&type=date&legend=top-left">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/image?repos=ronak-create/Foundation-Cli&type=date&theme=dark&legend=top-left" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/image?repos=ronak-create/Foundation-Cli&type=date&legend=top-left" />
   <img alt="Star History Chart" src="https://api.star-history.com/image?repos=ronak-create/Foundation-Cli&type=date&legend=top-left" />
 </picture>
</a>
---
